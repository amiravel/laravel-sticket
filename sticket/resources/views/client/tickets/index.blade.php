                ...
                <div>
                    @foreach ($tickets as $ticket)
                        <div class="py-1 px-3 d-flex justify-content-between text-center my-2 border-bottom">
                            ...
                            <div class="w-25 text-white rounded me-1 {{$ticket->status_color}}">{{$ticket->status}}</div>
                            <div class="w-25 text-white rounded {{$ticket->priority_color}}">{{$ticket->priority_text}}</div>
